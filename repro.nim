## Reprobuild dev env + build recipe for codetracer-solana-recorder.
##
...
package codetracer_solana_recorder:
  ...
  build:
    ...
    const traceFormatNimExtraPaths =
      ...
      "../../codetracer-solana-recorder/.reprobuild-src/libs/nim-stew:" &
      "../../codetracer-solana-recorder/reprobuild/libs/results/src:" &
      "../../codetracer-solana-recorder/reprobuild/libs/nim-stew"
    ...
    let recorderBuild = cargo.build(
      locked = true,
      release = true,
      actionId = "codetracer-solana-recorder.cargo-build",
      extraInputs = @[
